...
```
     ...
     ├─────────────────────────────────────────────────────────────────┤
     │                                                                 │
     │   /              Default - Promise API (sessions, messages...)  │
     │   /atoms         Effect programs (SessionAtom, MessageAtom...)  │
     │   /effect        Re-exports atoms (alias for /atoms)            │
     │   /router        Effect-based router with adapters              │
     │   /discovery     Server discovery utilities                     │
...
```
     ...
     ├───────────────────────────────────────────────────────────────┤
     │                                                               │
     │   📦  @opencode-vibe/react    React hooks & providers         │
     │                                                               │
     │   🔍  servers.list()          Find running OpenCode instances │
     │                                                               │
     │   ⚡  SSE events               Real-time sync                  │
     │                                                               │
     │   🧙  Effect patterns          Advanced composition           │
     │                                                               │
     ╰───────────────────────────────────────────────────────────────╯
```
